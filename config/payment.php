...
return [
    ...
    */
    ...
    'gateway-cred'  =>  [
        ...
        'sslwireless' => [
            'store_id'  =>  env('SSL_STORE_ID','xente607aa34091c7f'), //TODO::Ssl-wireless provided STORE_ID
            'store_pass' =>  env('SSL_STORE_PASSWORD','xente607aa34091c7f'), //TODO::Ssl-wireless provided STORE_PASSWORD
        ],
    ],
